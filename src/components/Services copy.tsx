...
const Services: React.FC<ServicesProps> = ({ limit }) => {
  ...
  return (
    <section
      id="services"
      className="py-12 px-47 md:py-20 bg-gray-50 overflow-hidden"
    >
      <div className="container mx-auto px-4 max-w-full">
        {/* Section Header */}
        <div className="text-center mb-8 md:mb-12 overflow-hidden">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-3 md:mb-4 wrap-break-word overflow-wrap-anywhere">
            Our Services
          </h2>
          <p className="text-lg sm:text-xl md:text-2xl font-bengali text-gray-700 mb-3 md:mb-4 wrap-break-word overflow-wrap-anywhere">
            আমাদের সেবাসমূহ
          </p>
          <p className="text-sm md:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed wrap-break-word overflow-wrap-anywhere">
            We provide comprehensive eye care services with state-of-the-art
            technology and expert medical professionals.
          </p>
          <p className="text-sm md:text-base lg:text-lg text-gray-600 mt-4 max-w-2xl mx-auto leading-relaxed wrap-break-word font-bengali">
            আমরা অত্যাধুনিক প্রযুক্তি এবং অভিজ্ঞ বিশেষজ্ঞ চিকিৎসক দলের মাধ্যমে
            পূর্ণাঙ্গ ডায়াগনস্টিক সেবা ও বিশেষায়িত চক্ষু চিকিৎসা প্রদান করি।
            আপনার পরিবারের সুস্বাস্থ্য নিশ্চিত করতে আমরা সর্বদা প্রতিশ্রুতিবদ্ধ।
          </p>
        </div>
        ...
        {loading && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {[1, 2, 3, 4].map((n) => (
              <div
                key={n}
                className="bg-white rounded-xl p-4 md:p-6 shadow-md animate-pulse overflow-hidden"
              >
        ...
        {error && !loading && (
          <div className="text-center py-8 md:py-12 overflow-hidden">
            <div className="text-red-600 text-base md:text-lg mb-4 wrap-break-word overflow-wrap-anywhere">
              {error}
            </div>
            <button
        ...
        {!loading && !error && services.length === 0 && (
          <div className="text-center py-8 md:py-12 overflow-hidden">
            ...
            <p className="text-lg md:text-xl text-gray-600 wrap-break-word overflow-wrap-anywhere">
              No services available
            </p>
            <p className="text-gray-500 wrap-break-word overflow-wrap-anywhere">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {services.map((service, index) => (
              ...
              >
                ...
                <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-2 leading-tight wrap-break-word overflow-wrap-anywhere">
                  {service.title}
                </h3>
